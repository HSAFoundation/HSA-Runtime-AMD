...
#define STA_AMDGPU_HSA_DEFAULT        0
#define STA_AMDGPU_HSA_GLOBAL_PROGRAM 1
#define STA_AMDGPU_HSA_GLOBAL_AGENT   2
#define STA_AMDGPU_HSA_READONLY_AGENT 3

// ELF Symbol Flag Enumeration Values.
#define STF_AMDGPU_HSA_CONST 1
